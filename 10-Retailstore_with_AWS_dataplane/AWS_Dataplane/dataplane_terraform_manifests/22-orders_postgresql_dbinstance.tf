...
resource "aws_db_instance" "orders_postgres" {
  ...
  db_name                 = "ordersdb"
  username                = local.retailstore_secret_json.username # Getting from 10 and AWS Secret Manager secret "retailstore-db-secret-1"
  password                = local.retailstore_secret_json.password # Getting from 10 and AWS Secret Manager secret "retailstore-db-secret-1"
  port                    = 5432
